...
define config.name = _("TEAM SUPERS")
...
define build.name = "CaptainHaiji"
...
define config.main_menu_music = "theme.mp3"
...
define config.save_directory = "CaptainHaiji-1560756107"
